...
<html>
  <head>
    ...
    <title>Sistemita | Departamentos</title>
      ...
      <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"><a href="deptos.php"> <i class="icon-presentation"></i>Departamentos </a></li>
        ...
        <div class="page-content">
          ...
          <div class="page-header no-margin-bottom">
            <div class="container-fluid">
              <h2 class="h5 no-margin-bottom">Departamentos</h2>
            </div>
          </div>
          <!-- Breadcrumb-->
          <div class="container-fluid">
                  ...
                  <div class="block">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover">
                        ...
                        <tbody>
                          <?php
                            $deptos = $db->select("departamentos",["departamentos.dpto_id", "departamentos.dpto_nom", "departamentos.dpto_fa"]);
...
<div id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"><strong id="exampleModalLabel" class="modal-title">Agregar departamento</strong>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="guardarDep" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
